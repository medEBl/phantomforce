 ...
 */
class getReponseQuestionnaireRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ReponseQuestionnaireRepository' shared autowired service.
     *
     * @return \App\Repository\ReponseQuestionnaireRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ReponseQuestionnaireRepository.php';

        return $container->privates['App\\Repository\\ReponseQuestionnaireRepository'] = new \App\Repository\ReponseQuestionnaireRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
