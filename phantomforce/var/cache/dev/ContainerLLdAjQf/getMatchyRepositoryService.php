 ...
 */
class getMatchyRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\MatchyRepository' shared autowired service.
     *
     * @return \App\Repository\MatchyRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'MatchyRepository.php';

        return $container->privates['App\\Repository\\MatchyRepository'] = new \App\Repository\MatchyRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
