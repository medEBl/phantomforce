 ...
 */
class getTournamentRewardRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TournamentRewardRepository' shared autowired service.
     *
     * @return \App\Repository\TournamentRewardRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TournamentRewardRepository.php';

        return $container->privates['App\\Repository\\TournamentRewardRepository'] = new \App\Repository\TournamentRewardRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
