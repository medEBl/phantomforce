 ...
 */
class getQuestionnaireAgentRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\QuestionnaireAgentRepository' shared autowired service.
     *
     * @return \App\Repository\QuestionnaireAgentRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'QuestionnaireAgentRepository.php';

        return $container->privates['App\\Repository\\QuestionnaireAgentRepository'] = new \App\Repository\QuestionnaireAgentRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
