...
class __TwigTemplate_6da1fc2f7c08cc13e8f3533728985006 extends Template
{
...
";
    ...
    <div class=\"filter-bar\">
        ...
        // line 466
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((isset($context["searchQuery"]) || array_key_exists("searchQuery", $context) ? $context["searchQuery"] : (function () { throw new RuntimeError('Variable "searchQuery" does not exist.', 466, $this->source); })()), "html", null, true);
        yield "\">
        ...
        // line 473
        if (((isset($context["currentSort"]) || array_key_exists("currentSort", $context) ? $context["currentSort"] : (function () { throw new RuntimeError('Variable "currentSort" does not exist.', 473, $this->source); })()) == "startDate")) {
            yield "selected";
        }
        yield "><i class=\"far fa-calendar-alt me-2\"></i> Date de début</option>
                    <option value=\"name\" ";
        // line 474
        if (((isset($context["currentSort"]) || array_key_exists("currentSort", $context) ? $context["currentSort"] : (function () { throw new RuntimeError('Variable "currentSort" does not exist.', 474, $this->source); })()) == "name")) {
            yield "selected";
        }
        yield "><i class=\"fas fa-font me-2\"></i> Nom</option>
                    <option value=\"game\" ";
        // line 475
        if (((isset($context["currentSort"]) || array_key_exists("currentSort", $context) ? $context["currentSort"] : (function () { throw new RuntimeError('Variable "currentSort" does not exist.', 475, $this->source); })()) == "game")) {
            yield "selected";
        }
        yield "><i class=\"fas fa-gamepad me-2\"></i> Jeu</option>
            ...
            <div class=\"col-md-2\">
                ...
                <select name=\"order\" class=\"form-control-pf\">
                    <option value=\"DESC\" ";
        // line 481
        if (((isset($context["currentOrder"]) || array_key_exists("currentOrder", $context) ? $context["currentOrder"] : (function () { throw new RuntimeError('Variable "currentOrder" does not exist.', 481, $this->source); })()) == "DESC")) {
            yield "selected";
        }
        yield ">📉 Décroissant</option>
                    <option value=\"ASC\" ";
        // line 482
        if (((isset($context["currentOrder"]) || array_key_exists("currentOrder", $context) ? $context["currentOrder"] : (function () { throw new RuntimeError('Variable "currentOrder" does not exist.', 482, $this->source); })()) == "ASC")) {
            yield "selected";
        }
    ...
    <div class=\"row g-4\">
        ...
        $context['_seq'] = CoreExtension::ensureTraversable((isset($context["tournaments"]) || array_key_exists("tournaments", $context) ? $context["tournaments"] : (function () { throw new RuntimeError('Variable "tournaments" does not exist.', 498, $this->source); })()));
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["tournament"]) {
            ...
            // line 502
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["tournament"], "game", [], "any", false, false, false, 502), "html", null, true);
            yield "</span>
                        ";
            // line 503
            if ((($tmp =  !CoreExtension::getAttribute($this->env, $this->source, $context["tournament"], "isActive", [], "any", false, false, false, 503)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                // line 504
            ...
            // line 510
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["tournament"], "name", [], "any", false, false, false, 510), "html", null, true);
            yield "</h3>
                    ...
                    <div class=\"tournament-info\">
                        ...
                        <span>";
            // line 514
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Twig\Extension\CoreExtension']->formatDate(CoreExtension::getAttribute($this->env, $this->source, $context["tournament"], "startDate", [], "any", false, false, false, 514), "d/m/Y"), "html", null, true);
            yield " – ";
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Twig\Extension\CoreExtension']->formatDate(CoreExtension::getAttribute($this->env, $this->source, $context["tournament"], "endDate", [], "any", false, false, false, 514), "d/m/Y"), "html", null, true);
            yield "</span>
                    </div>
                    ...
                    <div class=\"tournament-info\">
                        ...
                        <span>";
            // line 519
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["tournament"], "phase", [], "any", false, false, false, 519), "html", null, true);
            yield "</span>
                    </div>
                    ...
                    <div class=\"tournament-actions\">
                        <a href=\"";
            // line 523
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_tournament_detail", ["id" => CoreExtension::getAttribute($this->env, $this->source, $context["tournament"], "id", [], "any", false, false, false, 523)]), "html", null, true);
            yield "\" class=\"btn-view\">
                        ...
                        <a href=\"";
            // line 527
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_tournament_edit", ["id" => CoreExtension::getAttribute($this->env, $this->source, $context["tournament"], "id", [], "any", false, false, false, 527)]), "html", null, true);
            ...
            // line 531
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_tournament_toggle", ["id" => CoreExtension::getAttribute($this->env, $this->source, $context["tournament"], "id", [], "any", false, false, false, 531)]), "html", null, true);
            yield "\" style=\"display:inline-block;\">
                            <button type=\"submit\" class=\"btn-action\" title=\"";
            // line 532
            if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, $context["tournament"], "isActive", [], "any", false, false, false, 532)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                yield "Masquer";
            } else {
                yield "Afficher";
            }
            yield "\">
                                <i class=\"fas ";
            // line 533
            if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, $context["tournament"], "isActive", [], "any", false, false, false, 533)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                yield "fa-eye-slash";
            } else {
                yield "fa-eye";
            }
            yield "\"></i>
                        ...
                        <form method=\"post\" action=\"";
            // line 537
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_tournament_delete", ["id" => CoreExtension::getAttribute($this->env, $this->source, $context["tournament"], "id", [], "any", false, false, false, 537)]), "html", null, true);
            yield "\" onsubmit=\"return confirm('Êtes-vous sûr de vouloir supprimer ce tournoi ?');\" style=\"display:inline-block;\">
                            <input type=\"hidden\" name=\"_token\" value=\"";
            // line 538
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderCsrfToken(("delete" . CoreExtension::getAttribute($this->env, $this->source, $context["tournament"], "id", [], "any", false, false, false, 538))), "html", null, true);
            yield "\">
...
";
    ...
    {
        return array (  776 => 554,  764 => 547,  762 => 546,  749 => 538,  745 => 537,  734 => 533,  726 => 532,  722 => 531,  715 => 527,  708 => 523,  701 => 519,  691 => 514,  684 => 510,  680 => 508,  676 => 506,  672 => 504,  670 => 503,  666 => 502,  661 => 499,  656 => 498,  644 => 489,  632 => 482,  626 => 481,  615 => 475,  609 => 474,  603 => 473,  593 => 466,  586 => 462,  575 => 454,  569 => 451,  560 => 444,  547 => 443,  101 => 6,  88 => 5,  65 => 3,  42 => 1,);
    }
