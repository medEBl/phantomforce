...
/* base_back.html.twig */
class __TwigTemplate_7f6b655d900f98543b04ba42e8e7782a extends Template
{
...
<body>
    ...
    {
        return array (  617 => 442,  595 => 404,  573 => 299,  550 => 7,  538 => 443,  536 => 442,  497 => 405,  495 => 404,  475 => 387,  456 => 371,  447 => 365,  437 => 358,  427 => 351,  418 => 345,  409 => 339,  399 => 332,  389 => 325,  380 => 319,  369 => 311,  356 => 300,  354 => 299,  59 => 7,  52 => 2,);
    }

    public function getSourceContext(): Source
    {
        return new Source("{# templates/base_back.html.twig #}
<!DOCTYPE html>
<html lang=\"fr\">
<head>
    <meta charset=\"UTF-8\">
    <meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0\">
    <title>{% block title %}🎮 ARENA - Admin Panel{% endblock %}</title>
...
<body>
    ...
    <div class=\"admin-wrapper\">
        ...
        <aside class=\"admin-sidebar\" id=\"adminSidebar\">
            <div class=\"sidebar-header\">
                <a href=\"{{ path('app_back_dashboard') }}\" class=\"admin-brand\">
                    <i class=\"fas fa-gamepad\"></i>
                    <span>ARENA ADMIN</span>
                </a>
            </div>
            ...
            <nav class=\"admin-nav\">
                <div class=\"nav-item\">
                    <a href=\"{{ path('app_back_dashboard') }}\" class=\"nav-link\">
                        <i class=\"fas fa-tachometer-alt\"></i>
                        <span>Dashboard</span>
                    </a>
                </div>
                ...
                <div class=\"nav-item\">
                    <a href=\"{{ path('app_back_matchy_index') }}\" class=\"nav-link\">
                        <i class=\"fas fa-trophy\"></i>
                        <span>Matchs</span>
                    </a>
                </div>
                ...
                <div class=\"nav-item\">
                    <a href=\"{{ path('app_back_team_index') }}\" class=\"nav-link\">
                        <i class=\"fas fa-users\"></i>
                        <span>Équipes</span>
                    </a>
                </div>
                <div class=\"nav-item\">
                    <a href=\"{{ path('app_agent_index') }}\" class=\"nav-link\">
                        <i class=\"fas fa-users\"></i>
                        <span>Champions</span>
                    </a>
                </div>
                <div class=\"nav-item\">
                    <a href=\"{{ path('app_questionnaire_agent_index') }}\" class=\"nav-link\">
                        <i class=\"fas fa-users\"></i>
                        <span>Questionnaires</span>
                    </a>
                </div>
                <!-- AJOUT DES NOUVEAUX BOUTONS -->
                <div class=\"nav-item\">
                    <a href=\"{{ path('app_back_training_plan_manage') }}\" class=\"nav-link\">
                        <i class=\"fas fa-dumbbell\"></i>
                        <span>Plans d'Entraînement</span>
                    </a>
                </div>
                ...
                <div class=\"nav-item\">
                    <a href=\"{{ path('app_back_coaching_session_manage') }}\" class=\"nav-link\">
                        <i class=\"fas fa-calendar-check\"></i>
                        <span>Sessions de Coaching</span>
                    </a>
                </div>
                <div class=\"nav-item\">
                    <a href=\"{{ path('app_back_payment_index') }}\" class=\"nav-link\">
                        <i class=\"fas fa-calendar-check\"></i>
                        <span>Boutique</span>
                    </a>
                </div>
                ...
                <div class=\"nav-item\">
                    <a href=\"{{ path('app_acceuil') }}\" class=\"nav-link\">
                        <i class=\"fas fa-external-link-alt\"></i>
                        <span>Voir le site</span>
                    </a>
                </div>
