      ...
      ";
          ...
          ";
            ...
            ";
                ...
                // line 175
                yield "            ";
                if (!CoreExtension::inFilter(CoreExtension::getAttribute($this->env, $this->source, $context["agent"], "id", [], "any", false, false, false, 175), (isset($context["answeredIds"]) || array_key_exists("answeredIds", $context) ? $context["answeredIds"] : (function () { throw new RuntimeError('Variable "answeredIds" does not exist.', 175, $this->source); })()))) {
                    // line 176
                    yield "                <a class=\"btn btn-danger\" href=\"";
                    yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("front_agent_questionnaire_edit", ["id" => CoreExtension::getAttribute($this->env, $this->source, $context["agent"], "id", [], "any", false, false, false, 176)]), "html", null, true);
                    yield "\">
            ...
            <a class=\"btn btn-secondary\" href=\"";
                // line 181
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("front_agent_edit", ["id" => CoreExtension::getAttribute($this->env, $this->source, $context["agent"], "id", [], "any", false, false, false, 181)]), "html", null, true);
                yield "\">
            ...
            <form method=\"post\"
                  action=\"";
                // line 186
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("front_agent_delete", ["id" => CoreExtension::getAttribute($this->env, $this->source, $context["agent"], "id", [], "any", false, false, false, 186)]), "html", null, true);
                yield "\"
                  style=\"display:inline\"
                  onsubmit=\"return confirm('Supprimer cet agent ?');\">
              <input type=\"hidden\" name=\"_token\" value=\"";
                // line 189
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderCsrfToken(("delete_agent_" . CoreExtension::getAttribute($this->env, $this->source, $context["agent"], "id", [], "any", false, false, false, 189))), "html", null, true);
                yield "\">
...
";
    ...
    {
        return array (  407 => 199,  403 => 197,  389 => 189,  383 => 186,  375 => 181,  372 => 180,  364 => 176,  361 => 175,  359 => 174,  352 => 169,  348 => 167,  343 => 163,  339 => 161,  332 => 157,  328 => 155,  326 => 154,  321 => 151,  315 => 147,  312 => 146,  307 => 143,  302 => 142,  294 => 139,  289 => 136,  285 => 134,  281 => 131,  277 => 130,  274 => 129,  268 => 125,  266 => 124,  263 => 123,  257 => 122,  248 => 119,  245 => 118,  240 => 117,  235 => 116,  225 => 108,  216 => 101,  203 => 100,  101 => 7,  88 => 6,  65 => 4,  42 => 2,);
    }
