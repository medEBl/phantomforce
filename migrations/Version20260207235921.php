 ...
 */
final class Version20260207235921 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX uq_agent_game ON questionnaire_agent');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX uq_agent_game ON questionnaire_agent (id_agent, game)');
    }
}
