...
class getForm_RegistryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry([new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'App\\Form\\AgentEditType' => ['privates', 'App\\Form\\AgentEditType', 'getAgentEditTypeService', true],
            'App\\Form\\AgentType' => ['privates', 'App\\Form\\AgentType', 'getAgentTypeService', true],
            'App\\Form\\CoachingSessionType' => ['privates', 'App\\Form\\CoachingSessionType', 'getCoachingSessionTypeService', true],
            'App\\Form\\FrontAgentCreateType' => ['privates', 'App\\Form\\FrontAgentCreateType', 'getFrontAgentCreateTypeService', true],
            'App\\Form\\MatchyType' => ['privates', 'App\\Form\\MatchyType', 'getMatchyTypeService', true],
            'App\\Form\\PaymentType' => ['privates', 'App\\Form\\PaymentType', 'getPaymentTypeService', true],
            'App\\Form\\PlanEntrainementForm' => ['privates', 'App\\Form\\PlanEntrainementForm', 'getPlanEntrainementFormService', true],
            'App\\Form\\QuestionnaireAgentType' => ['privates', 'App\\Form\\QuestionnaireAgentType', 'getQuestionnaireAgentTypeService', true],
            'App\\Form\\RegistrationFormType' => ['privates', 'App\\Form\\RegistrationFormType', 'getRegistrationFormTypeService', true],
            'App\\Form\\ReponseQuestionnaireType' => ['privates', 'App\\Form\\ReponseQuestionnaireType', 'getReponseQuestionnaireTypeService', true],
            'App\\Form\\SessionCoachingForm' => ['privates', 'App\\Form\\SessionCoachingForm', 'getSessionCoachingFormService', true],
            'App\\Form\\ShopItemType' => ['privates', 'App\\Form\\ShopItemType', 'getShopItemTypeService', true],
            'App\\Form\\TeamType' => ['privates', 'App\\Form\\TeamType', 'getTeamTypeService', true],
            'App\\Form\\TournamentRewardType' => ['privates', 'App\\Form\\TournamentRewardType', 'getTournamentRewardTypeService', true],
            'App\\Form\\TournamentType' => ['privates', 'App\\Form\\TournamentType', 'getTournamentTypeService', true],
            'App\\Form\\TrainingPlanType' => ['privates', 'App\\Form\\TrainingPlanType', 'getTrainingPlanTypeService', true],
            ...
            'App\\Form\\AgentEditType' => '?',
            'App\\Form\\AgentType' => '?',
            'App\\Form\\CoachingSessionType' => '?',
            'App\\Form\\FrontAgentCreateType' => '?',
            'App\\Form\\MatchyType' => '?',
            'App\\Form\\PaymentType' => '?',
            'App\\Form\\PlanEntrainementForm' => '?',
            'App\\Form\\QuestionnaireAgentType' => '?',
            'App\\Form\\RegistrationFormType' => '?',
            'App\\Form\\ReponseQuestionnaireType' => '?',
            'App\\Form\\SessionCoachingForm' => '?',
            'App\\Form\\ShopItemType' => '?',
            'App\\Form\\TeamType' => '?',
            'App\\Form\\TournamentRewardType' => '?',
            'App\\Form\\TournamentType' => '?',
            'App\\Form\\TrainingPlanType' => '?',
