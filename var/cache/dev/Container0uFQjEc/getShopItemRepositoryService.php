 ...
 */
class getShopItemRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ShopItemRepository' shared autowired service.
     *
     * @return \App\Repository\ShopItemRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ShopItemRepository.php';

        return $container->privates['App\\Repository\\ShopItemRepository'] = new \App\Repository\ShopItemRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
